    ...
    <div className="flex flex-col gap-6 p-6 bg-white min-h-screen">
      ...
      <header className="flex justify-between items-center">
        ...
        <div className="flex gap-3">
          <button className="flex items-center bg-white border-2 border-orange-500 text-orange-500 rounded-lg px-5 py-2 hover:bg-orange-50 transition-colors font-medium">
            <span className="mr-2">+</span> Add provisional plan
          </button>
          <button className="flex items-center bg-orange-500 text-white rounded-lg px-5 py-2 hover:bg-orange-600 transition-colors font-medium">
